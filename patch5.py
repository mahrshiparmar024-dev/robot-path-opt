...
# We use re.sub but with a lambda to avoid backslash processing by re's replacer
text = pattern.sub(lambda m: new_opt, text)
...
print("Patch via python lambda string applied successfully.")
